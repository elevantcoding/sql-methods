...
/****** Object:  UserDefinedFunction [elevant].[CipherString]    Script Date: 12/28/2025 1:57:53 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER FUNCTION [elevant].[CipherString](@string varchar(128), @vals nvarchar(6), @randval tinyint, @ciph nvarchar(10), @padding nvarchar(128))
...
BEGIN
	...
	DECLARE @hexstring nvarchar(256);
	DECLARE @hexvalue nvarchar(2);
	...
	-- create prefix / key
	SET @prefix = CONCAT(@altervals, CAST(@randval AS nvarchar(1)), CAST(@v AS nvarchar(1)), FORMAT(@strLen,'000'))
